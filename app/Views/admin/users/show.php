                            ...
                            <tbody>
                                <?php foreach ($transactions as $transaction) : ?>
                                    <tr style="border-bottom: 1px solid rgba(15, 23, 42, 0.08);">
                                        <td style="padding: 8px 6px;"><?= esc($transaction['type'] ?? '-') ?></td>
                                        <td style="padding: 8px 6px;"><?= esc(number_format((float) ($transaction['montant'] ?? 0), 2, ',', ' ')) ?></td>
                                        <td style="padding: 8px 6px;"><?= esc($transaction['date_transaction'] ?? '-') ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
